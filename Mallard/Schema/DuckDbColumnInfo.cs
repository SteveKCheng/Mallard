...
public readonly record struct DuckDbColumnInfo
{
    ...
    internal static string? GetSqlNameForValueKind(DuckDbValueKind kind)
        => kind switch
        {
            ...
            DuckDbValueKind.Timestamp => "TIMESTAMP",
            ...
            DuckDbValueKind.TimestampSeconds => "TIMESTAMP_S",
            DuckDbValueKind.TimestampMilliseconds => "TIMESTAMP_MS",
            DuckDbValueKind.TimestampNanoseconds => "TIMESTAMP_NS",
            ...
            DuckDbValueKind.TimeTz => "TIMETZ",
            DuckDbValueKind.TimestampTz => "TIMESTAMPTZ",
            ...
            DuckDbValueKind.TimeNanoseconds => "TIME_NS",
            _ => null
        };
}
